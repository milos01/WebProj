				...
				<c:when test="${logedUser.role.roleName == 'Manager'}">
					...
					<div class="tab-panels"
						...
						<div style="background-color: #F3F3F4; height: 100%" id="panel1"
							class="panel active">
							<h1
								style="margin-top: 7px; margin-left: 40px; font-family: cursive; font-family: fantasy; font-size: 44px;">${restoran.name}</h1>
							<div
								style="border-radius: 5px; border: 1px solid #C0C0C0; width: 192px; margin-top: 15px; float: left;">
							...
							<div class="Contact"
								style="border: 1px solid #C0C0C0; border-radius: 5px; float: left;">
								<table>
							...
							<button data-toggle="modal" data-target="#editInfoRestaurant"
								class="btn btn-primary btn-md"
								style="position: absolute; top: 500px;">Edit</button>
									...
									<div class="modal-content">
										...
										<form action="editRestaurant" method="POST">
											<input class="form-control" name="name" type="text"
												...
												id="desription" placeholder="description"
									...
									<div class="modal-content">
										...
										<form action="addNewStaff" method="POST">
											...
											<input class="form-control" type="text" id="lastName"
												placeholder="Last name"
												style="width: 300px; height: 45px; margin: auto auto; margin-top: 15px;"
												name="lastName" ; /> <input class="form-control"
											...
											<select class="form-control" id="role" name="role_id"
												...
												name="birth_day" placeholder="Shoe number" maxlength="2"
												style="width: 300px; height: 45px; margin: auto auto; margin-top: 15px;" />
